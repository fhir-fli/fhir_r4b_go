...
// UnmarshalJSON populates DeviceRequest from JSON data.
func (m *DeviceRequest) UnmarshalJSON(data []byte) error {
	temp := struct {
		Id *FhirString `json:"id,omitempty"`
		Meta *FhirMeta `json:"meta,omitempty"`
		ImplicitRules *FhirUri `json:"implicitrules,omitempty"`
...
// MarshalJSON converts DeviceRequest to JSON data.
func (m *DeviceRequest) MarshalJSON() ([]byte, error) {
	output := struct {
...
// UnmarshalJSON populates DeviceRequestParameter from JSON data.
func (m *DeviceRequestParameter) UnmarshalJSON(data []byte) error {
	temp := struct {
		Id *FhirString `json:"id,omitempty"`
		Extension_ []*FhirExtension `json:"extension,omitempty"`
		ModifierExtension []*FhirExtension `json:"modifierextension,omitempty"`
...
// MarshalJSON converts DeviceRequestParameter to JSON data.
func (m *DeviceRequestParameter) MarshalJSON() ([]byte, error) {
	output := struct {
		Id interface{} `json:"id,omitempty"`
		IdElement map[string]interface{} `json:"_id,omitempty"`
		Extension_ []*FhirExtension `json:"extension,omitempty"`
