...
// UnmarshalJSON populates Count from JSON data.
func (m *Count) UnmarshalJSON(data []byte) error {
	temp := struct {
		Id *FhirString `json:"id,omitempty"`
		Extension_ []*FhirExtension `json:"extension,omitempty"`
		Value *FhirDecimal `json:"value,omitempty"`
...
// MarshalJSON converts Count to JSON data.
func (m *Count) MarshalJSON() ([]byte, error) {
	output := struct {
