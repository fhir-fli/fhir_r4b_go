...
// UnmarshalJSON populates FhirDuration from JSON data.
func (m *FhirDuration) UnmarshalJSON(data []byte) error {
	temp := struct {
		Id *FhirString `json:"id,omitempty"`
		Extension_ []*FhirExtension `json:"extension,omitempty"`
		Value *FhirDecimal `json:"value,omitempty"`
...
// MarshalJSON converts FhirDuration to JSON data.
func (m *FhirDuration) MarshalJSON() ([]byte, error) {
	output := struct {
...
// Equals checks equality between two FhirDuration instances.
