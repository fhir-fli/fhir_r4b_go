...
// UnmarshalJSON populates Age from JSON data.
func (m *Age) UnmarshalJSON(data []byte) error {
	temp := struct {
		Id *FhirString `json:"id,omitempty"`
		Extension_ []*FhirExtension `json:"extension,omitempty"`
		Value *FhirDecimal `json:"value,omitempty"`
...
// MarshalJSON converts Age to JSON data.
func (m *Age) MarshalJSON() ([]byte, error) {
	output := struct {
...
// Equals checks equality between two Age instances.
