...
// UnmarshalJSON populates FhirExtension from JSON data.
func (m *FhirExtension) UnmarshalJSON(data []byte) error {
	temp := struct {
		Id *FhirString `json:"id,omitempty"`
		Extension_ []*FhirExtension `json:"extension,omitempty"`
		Url *FhirString `json:"url,omitempty"`
...
// MarshalJSON converts FhirExtension to JSON data.
func (m *FhirExtension) MarshalJSON() ([]byte, error) {
	output := struct {
