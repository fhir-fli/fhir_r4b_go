...
const (
	...
	TaskCode_Approve TaskCode = iota
	...
	TaskCode_Fulfill TaskCode = iota
	...
	TaskCode_Resume TaskCode = iota
)

// String converts the enum to its string representation
func (e TaskCode) String() string {
	switch e {
	case TaskCode_Approve: return "Activate/approve the focal resource"
	case TaskCode_Fulfill: return "Fulfill the focal request"
	case TaskCode_Abort: return "Mark the focal resource as no longer active"
	case TaskCode_Replace: return "Replace the focal resource with the input resource"
	case TaskCode_Change: return "Change the focal resource"
	case TaskCode_Suspend: return "Suspend the focal resource"
	case TaskCode_Resume: return "Re-activate the focal resource"
